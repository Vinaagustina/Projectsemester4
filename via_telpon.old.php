                                ...
                                ?>
                                 <tr class="">
                                   ...
                                   <!-- <td><?php echo $rowProduct[''] ?></td>-->
                                    <td>
                                        <a href="cart_telpon.php?&input=add&id_barang=<?=$rowProduct['id']?>&id_session=<?=$id_session?>">
                    ...
                    <div class="blog-post">
                        ...
                        WHERE id_session='$id_session'";
                                    ...
                                    while ($data = mysqli_fetch_array($result)) {
                                        ...
                                        <tr>
                                            <td>
                                                <a href="hapus_keranjang_telepon.php?hapus=<?=$data['id_keranjang']?>&id_session=<?=$data['id_session'] ?>"><i
                                                    ...
                                                    <div class="modal-body row">
                                                        <div class="col-md-12">
                                                            <!--<form method="POST" action="?hal=cetak">-->
                                                                <form method="POST" action="form_kirim.php">
