...
$id_customer = $_POST['id_customer'];
                    ...
                    if($cek==0){
                        ...
                        $connect->query("UPDATE keranjang_telepon SET qty=qty+1, status=0 where id_session='$id_session' and id_barang='$id_barang' AND id_customer='$id_customer' AND status = 1 ");
                    }
                    else{
