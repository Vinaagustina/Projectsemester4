...
include "../templates/header.php"; ?>
      ...
      <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">ID Barang <span class="required">*</span></label>
      ...
      <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">ID Pembelian <span class="required">*</span></label>
      <div class="col-md-10 col-sm-10 col-xs-12">
      ...
      <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Nama Barang <span class="required">*</span></label>
		  <div class="col-md-10 col-sm-10 col-xs-12">
      ...
      <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Harga Beli <span class="required"></span></label>
      <div class="col-md-10 col-sm-10 col-xs-12">
     ...
     <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Harga Jual Satuan <span class="required"></span></label>
      <div class="col-md-10 col-sm-10 col-xs-12">
      ...
      <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Stok <span class="required"></span></label>
      <div class="col-md-10 col-sm-10 col-xs-12">
